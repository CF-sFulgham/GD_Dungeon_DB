...
export class Migration20250513092340 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table "reward" ("id" serial primary key, "title" int not null, "created_at" timestamptz not null);`);
